...
import com.Trading_plaform.Trading_platform.repository.CoinRepository;
import com.Trading_plaform.Trading_platform.services.CoinService;
...
public class CoinServiceImpl implements CoinService {
    ...
    public String getCoinDetails(String coinId) throws Exception {
        ...
        try {
            ...
            coin.setLastUpdated(String.valueOf(marketData.get("last_updated").asLong()));
    ...
    @Override
    public String getTop50CoinsByMarketCapRank() throws JsonProcessingException {
        ...
        try {
            ...
            for(Coin coin: coinList){
                sb.append(coin.getName()).append(" - ").append(coin.getSymbol()).append("\n");
            }
            return sb.toString();
